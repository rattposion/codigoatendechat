    ...
    <MainContainer>
      ...
      <Paper className={classes.mainPaper} variant="outlined" onScroll={handleScroll}>
        {schedules.length === 0 && !loading ? (
          <EmptyState
            title={i18n.t("schedules.emptyTitle") || "Nenhum agendamento encontrado"}
            description={
              i18n.t("schedules.emptyMessage") ||
              "Crie um agendamento para organizar seus contatos."
            }
            onAction={handleOpenScheduleModal}
            actionLabel={i18n.t("schedules.buttons.add")}
          />
        ) : (
          <Calendar
