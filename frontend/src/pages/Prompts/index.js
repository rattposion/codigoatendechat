...
const Prompts = () => {
  ...
  return (
    <MainContainer>
      ...
      />
      <MainHeader>
        <Title variant="h4">{i18n.t("prompts.title")}</Title>
      ...
      <Paper className={classes.mainPaper} variant="outlined">
        {(!loading && prompts.length === 0) ? (
          <EmptyState
            title={"Nenhum prompt configurado"}
            description={"Crie um prompt para começar."}
            actionLabel={i18n.t("prompts.buttons.add")}
            onAction={handleOpenPromptModal}
          />
        ) : (
          <Table size="small">
            <TableHead>
