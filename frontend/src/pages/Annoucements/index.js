    ...
    <MainContainer >
      ...
      >
        {announcements.length === 0 && !loading ? (
          <EmptyState
            title={i18n.t("announcements.emptyTitle") || "Nenhum comunicado encontrado"}
            description={
              i18n.t("announcements.emptyMessage") ||
              "Crie um comunicado para informar sua equipe."
            }
            onAction={handleOpenAnnouncementModal}
            actionLabel={i18n.t("announcements.buttons.add")}
          />
        ) : (
          <Table size="small">
            <TableHead>
