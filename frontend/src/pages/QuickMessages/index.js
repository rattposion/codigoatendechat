    ...
    <MainContainer>
      ...
      >
        {quickemessages.length === 0 && !loading ? (
          <EmptyState
            title={i18n.t("quickMessages.emptyTitle") || "Nenhuma mensagem rápida"}
            description={
              i18n.t("quickMessages.emptyMessage") ||
              "Crie mensagens rápidas para agilizar seus atendimentos."
            }
            onAction={handleOpenQuickMessageDialog}
            actionLabel={i18n.t("quickMessages.buttons.add")}
          />
        ) : (
          <Table size="small">
            <TableHead>
