    ...
    <MainContainer className={classes.mainContainer}>
      ...
      <Paper className={classes.mainPaper} variant="outlined" onScroll={handleScroll}>
        {(!loading && contacts.length === 0) ? (
          <EmptyState
            title={i18n.t("contacts.empty.title") || "Nenhum contato encontrado"}
            description={i18n.t("contacts.empty.description") || "Crie um contato manualmente ou importe um arquivo CSV."}
